            ...
            <div>
              <div class="d-flex flex-row align-items-center mb-4">
                <div class="form-outline flex-fill mb-0 input_row">
                  ...
                  <div>
                    <input type="email" class="form-control" style="width:70%; display:inline-block;" placeholder="Email" v-model="user.email" required />
                    <input type="button" class="btn btn-primary" value="중복확인" style="float:right; margin: 0px; width:27%;" @click="IdCheck" required>
                  </div>
                </div>
              </div>
              <div class="d-flex flex-row align-items-center mb-4">
